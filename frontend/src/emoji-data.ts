// Generated from unicode-emoji-json@0.9.0 (data-by-group.json, unicode.org emoji data).
// To refresh for a newer Unicode revision: npm view unicode-emoji-json versions,
// npm pack unicode-emoji-json@<ver>, and regenerate this file from its data-by-group.json
// (keep backend/src/data/emoji.json — from the same package's data-ordered-emoji.json — in sync).
